...
public:
	class UMaterialInstanceConstant* LandscapeMaterialInstance;
	class UTexture2D* HeightmapTextureData = nullptr;
	FVector4 HeightmapBoundsData;
	FVector4 ComponentBoundsData;
// FB Bulgakov End
