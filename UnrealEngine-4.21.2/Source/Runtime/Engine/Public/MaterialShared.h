...
public:
	...
	virtual UMaterialInterface* GetBlendMaterial() const = 0; // FB Bulgakov - Material blending
	...
	virtual bool HasBlendMaterialWeightConnected() const { return false; } // FB Bulgakov - Material blending
...
public:
	...
	ENGINE_API virtual UMaterialInterface* GetBlendMaterial() const override; // FB Bulgakov - Material blending
...
protected:
	...
	ENGINE_API virtual bool HasBlendMaterialWeightConnected() const override; // FB Bulgakov - Material blending
