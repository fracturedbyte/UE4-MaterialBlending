...
void FMaterialInstanceParameterDetails::CreateBasePropertyOverrideWidgets(IDetailLayoutBuilder& DetailLayout)
{
	...
	bool bShowBlendMaterial = !MaterialEditorInstance->BasePropertyOverrides.bLandscapeBlendMaterial;
	...
	TAttribute<bool> IsOverrideBlendMaterialEnabled = TAttribute<bool>::Create(TAttribute<bool>::FGetter::CreateSP(this, &FMaterialInstanceParameterDetails::OverrideBlendMaterialEnabled));
	...
	TSharedPtr<IPropertyHandle> BlendMaterialProperty = BasePropertyOverridePropery->GetChildHandle("BlendMaterial");
	...
	// FB Bulgakov Begin - Material blending
	if (bShowBlendMaterial)
	{
		IDetailPropertyRow& BlendMaterialsPropertyRow = BasePropertyOverrideGroup.AddPropertyRow(BlendMaterialProperty.ToSharedRef());
		BlendMaterialsPropertyRow
			.DisplayName(BlendMaterialProperty->GetPropertyDisplayName())
			.ToolTip(BlendMaterialProperty->GetToolTipText())
			.EditCondition(IsOverrideBlendMaterialEnabled, FOnBooleanValueChanged::CreateSP(this, &FMaterialInstanceParameterDetails::OnOverrideBlendMaterialChanged));
	}
	// FB Bulgakov End
}
// FB Bulgakov End
...
// FB Bulgakov Begin - Material blending
bool FMaterialInstanceParameterDetails::OverrideBlendMaterialEnabled() const
{
	return MaterialEditorInstance->BasePropertyOverrides.bOverride_BlendMaterial;
}
// FB Bulgakov End
...
// FB Bulgakov Begin - Material blending
void FMaterialInstanceParameterDetails::OnOverrideBlendMaterialChanged(bool NewValue)
{
	MaterialEditorInstance->BasePropertyOverrides.bOverride_BlendMaterial = NewValue;
	MaterialEditorInstance->PostEditChange();
	FEditorSupportDelegates::RedrawAllViewports.Broadcast();
}
// FB Bulgakov End
