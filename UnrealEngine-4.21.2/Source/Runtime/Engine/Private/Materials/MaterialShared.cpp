...
bool FMaterialResource::HasBlendMaterialWeightConnected() const { return HasMaterialAttributesConnected() || (!Material->bUseMaterialAttributes && Material->BlendMaterialWeight.IsConnected()); }
// FB Bulgakov End
...
// FB Bulgakov Begin - Material blending
UMaterialInterface* FMaterialResource::GetBlendMaterial() const
{
	return MaterialInstance ? MaterialInstance->GetBlendMaterial() : Material->GetBlendMaterial();
}
// FB Bulgakov End
...
FMaterialInstanceBasePropertyOverrides::FMaterialInstanceBasePropertyOverrides()
	...
	,bOverride_BlendMaterial(false) // FB Bulgakov - Material blending
...
bool FMaterialInstanceBasePropertyOverrides::operator==(const FMaterialInstanceBasePropertyOverrides& Other)const
{
	return	bOverride_OpacityMaskClipValue == Other.bOverride_OpacityMaskClipValue &&
			...
			bOverride_BlendMaterial == Other.bOverride_BlendMaterial && // FB Bulgakov - Material blending
			...
			BlendMaterial == Other.BlendMaterial && // FB Bulgakov - Material blending
...
void FMaterialAttributeDefinitionMap::InitializeAttributeMap()
{
	...
	Add(FGuid(0xD1DD967C, 0x12FC4296, 0x9D777BEE, 0xC12C8FED), TEXT("BlendMaterialWeight"),		MP_BlendMaterialWeight,		MCT_Float,	FVector4(0,0,0,0),	SF_Pixel); // FB Bulgakov - Material blending
