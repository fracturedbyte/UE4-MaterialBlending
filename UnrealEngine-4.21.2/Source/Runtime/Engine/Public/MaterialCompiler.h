...
public:
	...
	virtual int32 GetHeightmapValue(int32 CoordinateIndex) = 0; // FB Bulgakov - Material blending
	...
	virtual int32 BlendMaterialWeight() = 0; // FB Bulgakov - Material blending
...
public:
	...
	virtual int32 GetHeightmapValue(int32 CoordinateIndex) override { return Compiler->GetHeightmapValue(CoordinateIndex); } // FB Bulgakov - Material blending
	...
	virtual int32 BlendMaterialWeight() override { return Compiler->BlendMaterialWeight(); } // FB Bulgakov - Material blending
