...
void UMaterialGraph::RebuildGraph()
{
	...
	if (!MaterialFunction)
	{
		...
		MaterialInputs.Add(FMaterialInputInfo(LOCTEXT("BlendMaterialWeight", "Blend Material Weight"), MP_BlendMaterialWeight, LOCTEXT("BlendMaterialWeightToolTip", "Blend Material Weight")));
		// FB Bulgakov End
